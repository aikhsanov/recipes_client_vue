    ...
    >
      <div class="relative border-b border-white/20">
        <a class="flex items-center gap-4 py-6 px-8" href="#/"
          ><img
            src="https://cdn.gamedevmarket.net/wp-content/uploads/20210320102051/1f8141ff4c38a98c857c53f427d25e93.gif"
      ...
      <div class="m-4">
        <ul class="mb-4 flex flex-col gap-1">
          ...
          <li>
            <a class="" href="#/dashboard/notifactions"
              ><button
                class="
                  middle
                  none
    ...
    <div class="p-4 xl:ml-80">
          ...
          <div class="mb-12">
              ...
              ><a
                ...
                ><button
                  class="
                    ...
                    px-6
                    rounded-lg
                    border border-blue-gray-500
                    text-blue-gray-500
                    hover:opacity-75
                    focus:ring focus:ring-blue-gray-200
                    active:opacity-[0.85]
                    block
                    w-full
                  "
            ...
            <a
              ...
              ><div
                ...
                style="opacity: 1"
              >
                <div class="w-5 h-5 absolute top-2/4 left-1 -translate-y-2/4">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                ...
                <div class="ml-4 mt-px">178 - Stars</div>
              </div>
            ...
            <div class="mt-4 flex justify-center gap-2">
              <button
                class="
                  ...
                  to-blue-gray-400
                  text-white
                  shadow-md shadow-blue-gray-500/20
                  hover:shadow-lg hover:shadow-blue-gray-500/40
                  active:opacity-[0.85]
                  flex
                  items-center
                  gap-2
                ...
                type="button"
              >
                <i class="fa-brands fa-twitter text-white"></i>Tweet</button
              ><button
                class="
                  middle
                  none
                ...
                type="button"
              >
                <i class="fa-brands fa-facebook text-white"></i>Share
              </button>
            </div>
          </div>
        </div>
      ...
      <button
        class="
          ...
          text-blue-gray-900
          shadow-md
          hover:shadow-lg hover:shadow-blue-gray-500/20
