<template>
  ...
  <router-link
    v-else
    :to="props.to"
    :class="`bg-gray-100 hover:bg-gray-200 py-2 px-4 text-sm font-medium text-gray-800 border border-transparent rounded-lg focus:outline-none ${props.customButtonClass}`"
